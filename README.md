...
- [QuickTiny Image Compressor - Browser-based JPG/PNG compression using the Canvas API. Runs client-side; no files leave the browser.](https://quicktinyv2.vercel.app/compress-image)
